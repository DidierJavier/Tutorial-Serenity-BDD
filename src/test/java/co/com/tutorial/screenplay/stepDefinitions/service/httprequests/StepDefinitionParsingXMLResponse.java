...
public class StepDefinitionParsingXMLResponse {
    ...
    //Verificar la respuesta correcta de una peticion desde un valor en el body XML
    ...
    public void elTesterObservaQueLaRespuestaXMLEsCorrecta(Actor tester) {
        ...
        MatcherAssert.assertThat(xmlPath.getString("gesmes:Envelope.gesmes:subject"),
